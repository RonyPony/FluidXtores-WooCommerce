...
import 'package:fluidxtores/components/productTags.dart';
import 'package:fluidxtores/screens/details/components/product_categories.dart';
        ...
        TopRoundedContainer(
          ...
          child: Column(
            children: [
              ...
              AproductCategories(
                product: product, canSeeDetails: true,
              ),         
              TopRoundedContainer(
